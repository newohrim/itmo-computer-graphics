...
public:
	...
	virtual void Draw(Renderer* renderer, bool geomOnly = false);
	virtual void UpdateCBVS(Renderer* renderer, ConstantBuffers::CBuf& cBuf);
	virtual void UpdateCBPS(Renderer* renderer, ConstantBuffers::CBuf& cBuf);
