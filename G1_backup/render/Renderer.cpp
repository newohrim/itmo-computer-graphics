...
bool Renderer::Initialize(Window* _window)
{
	...
	rendererImpl = new DeferredRenderer(this);
	shadowMapper = new ShadowMapper(this);
...
void Renderer::Draw()
{
	...
	DefaultMeshMaterial::CBVS cbvs;
	DefaultMeshMaterial::CBPS cbps;
	PopulateLightsBuffer(cbps);
	for (DrawComponent* comp : components) {
		comp->UpdateCBVS(this, cbvs);
		comp->UpdateCBPS(this, cbps);
		comp->Draw(this);
	}
...
void Renderer::PopulateLightsBuffer(ConstantBuffers::CBuf& buffer) const
{
