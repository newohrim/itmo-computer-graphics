...
public:
	...
	void Draw(Renderer* renderer, bool geomOnly = false) override;

	void UpdateCBVS(Renderer* renderer, ConstantBuffers::CBuf& cBuf) override;

	void UpdateCBPS(Renderer* renderer, ConstantBuffers::CBuf& cBuf) override;
